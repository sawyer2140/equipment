...
$(document).ajaxStart(
    ...
    function() {
        ...
        var opts = {
            lines: 11,length: 4, width: 6,radius: 14,rotate: 5,
            color: '#fff',speed: 0.7,trail: 55,shadow: true,
            hwaccel: true, className: 'spinner', zIndex: 2e9,
            top: '2',left:'6'
        };

        this.spinner = new Spinner(opts).
            spin(document.getElementById('icoShow'));
...
function getAlertDiv(status) {
    ...
    div.append(button, strong, "    请继续进行相关操作!");
